...
local mapping = {
  ...
  ['n<C-h>'] = {":lua require'my.utils'.win_move('h')<CR>"},
  ['n<C-j>'] = {":lua require'my.utils'.win_move('j')<CR>"},
  ['n<C-k>'] = {":lua require'my.utils'.win_move('k')<CR>"},
  ['n<C-l>'] = {":lua require'my.utils'.win_move('l')<CR>"},

  -- Intelligent windows resizing using ctrl + arrow keys
  ['n<C-Right>'] = {":lua require'my.utils'.vertical_resize('right')<CR>"},
  ['n<C-Left>'] = {":lua require'my.utils'.vertical_resize('left')<CR>"},
  ['n<C-Up>'] = {":resize -1<CR>"},
  ...
  -- ['n<Leader>à'] = { ':call v:lua.toggle_number()' },
  ['n<Leader>à'] = {
    function()
